...
const VerifyEmail = () => {
    ...
    const handleChange = (index:number,value:string)=>{
        ...
        //from moving from one input field to anothe if a digit is entered
        if(value!==""&&index<5){
    ...
    <div className="flex items-center justify-center h-screen w-full">
        <div className="p-8 rounded-md w-full max-w-md flex flex-col gap-10 border border-gray-200">
            ...
            <form action="">
                ...
                {
                    loading ? <Button className="bg-orange hover:bg-hoverOrange mt-6 w-full"><Loader2 className="mr-2 w-4 h-4 animate-spin">Please Wait</Loader2></Button>:(
