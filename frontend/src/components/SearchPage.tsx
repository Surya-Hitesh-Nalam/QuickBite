          ...
          <div>
            <div className="flex flex-col gap-3 md:flex-row md:items-center md:gap-2 my-3">
              ...
              <div className="flex flex-wrap gap-2 mb-4 md:mb:0">
                {["biriyani", "momo", "friedrice"].map(
                  (selected: string, idx: number) => (
                    <div
                      key={idx}
                      className="relative inline-flex items-center max-w-full"
                    >
                      <Badge className="text-[#D19254] rounded-md hover:cursor-pointer pr-6 whitespace-normal" variant="outline">{selected}</Badge>
            ...
            <div className="grid md:grid-cols-3 gap-4 ">
                {
                    ...
                    <CardContent className="p-4">
                        ...
                        <div className="flex gap-2 mt-4 flex-wrap">
                            {
                                ["biriyani", "momo", "pizza"].map((cuisine: string, idx: number) => (
                                <Badge className="font-medium px-2 py-1 rounded-full shadow-md" key={idx}>{cuisine}</Badge>
                                ))
                            }
                        </div>
                    </CardContent>
